...
\newcommand{\muone}{{\color{red}\mu}}
\newcommand{\mutwo}{{\color{blue}\mu}}
\newcommand{\mufused}{{\color{darkgreen}\mu}}
...
\newcommand{\varone}{{\color{red}\sigma^2}}
\newcommand{\vartwo}{{\color{blue}\sigma^2}}
...
\newcommand{\xx}{\color{darkgreen}{\frac{ - \frac { \sigma_2^2 }{\sigma_1^2 + \sigma_2^2} (x-\mu)^2 - \frac{ \sigma_1^2 }{\varsum} (x-\mu)^2 } \divvarprodvarsum }}
